...
import { redirectToMyMenu } from "@/app/actions/redirect_actions";
import {
  BarChart3,
  Calendar,
  Settings,
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <header className="h-20 bg-white border-b border-gray-200 flex items-center justify-between px-6 sticky top-0 z-30">
          ...
          <div className="flex items-center">
            <form action={redirectToMyMenu} target="_blank" className="m-0 p-0 flex">
              <Button
                type="submit"
                variant="outline"
              ...
              <Button
                ...
                aria-label="Ver Cardápio Online"
              >
